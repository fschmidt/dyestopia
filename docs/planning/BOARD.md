...
| `T-012` Resolve the combo spike |   |   | `T-042` Move the board onto the extracted package |
| `T-024` Make the multiplier necessary |   |   | `T-043` Let the skill own the board rules |
