...
# Concepts
- find the right move should be more rewarding than finding a quick move
...
- suggestions (hint button) toggled via settings
...
- color mixing multipliers should change the visual style of the score info
